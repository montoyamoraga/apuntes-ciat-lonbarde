...
Intel inside: an esp_cafe running open source so you can write WETF you want in weirdness, or a web browser, smartphone synth, Star Trek filter or Bluetooth streaming (ESP32-A2DP)

Intel inside: The esp_cafe pairs an Analog Devices audio Interface for buttery twelve bit decimal Megahertz operation, with a current-mode Norton amplifier for classic analog sound.

Line Drivers: The quantum_experiment is hybrid, using Nortons for the critical duties: VCO, VCF, and VCA, and adds quality line driver amplifiers to drive the quantization features.

Dubstep Filter: The tier_horn gives you classic stereo enveloped sine gestures, like the deerhorn, but with a true thereminic (radio heterodyne) core.
...
Analog Tachometer: To answer this question, the tier_horn creates a CV by converting the sine to a square, then pulsing an integrator, an alchemy predating phase locked loops.

Boundary pusher: To answer this question, the tier_horn samples the boundaries of your radio gesture on the gold and lets you control how languid they decay to your rest position.

Error signal: To answer this question, The tier_horn then references these two boundaries to create an error signal, which is like an envelope so you thus have silence on the stereo output.

Dubstep Filter: The tier_horn uses your square waves update on “that RCA sound,” combining the boundary pusher and a secret dubstep wobbler, to “you guessed it,” filter them.
...
Positivity Boost: The tier_horn attenu-verter, a knob with the purple banana, gives you full inversion, but also a boost on the version. Twice the positivity and half the negativity!
